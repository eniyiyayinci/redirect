...
initAdvEvents: function() {
  ...
  // ⚠️ HATA DURUMUNDA MAÇ YAYININA GEÇ
  window.app.clappr.instance.on(Clappr.Events.PLAYER_ERROR, function(e) {
    console.warn("Reklam yüklenemedi, yayına geçiliyor...", e);
    window.app.skip(); // doğrudan maça geç
  });
},
